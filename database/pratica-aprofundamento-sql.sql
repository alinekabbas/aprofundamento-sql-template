-- Active: 1673994733657@@127.0.0.1@3306
...
-- Buscar pokémons que tenham speed maior que 60

SELECT * FROM pokemons WHERE speed > 60;

-- Buscar pokémons que tenham attack e special_attack maiores ou iguais a 60

SELECT * FROM pokemons WHERE attack >= 60 AND special_attack >= 60;

-- Buscar pokémons que tenham na coluna name o termo "saur" no final do texto
...
SELECT AVG(hp) as mediaStatsHp FROM pokemons;

SELECT COUNT(*) as countLinesPokemon FROM pokemons;
...
-- Busque novamente o número de pokémons cadastrados, mas agora agrupe o resultado baseado na coluna typ
SELECT 
    COUNT(*), 
    type 
    FROM pokemons
